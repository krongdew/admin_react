      ...
      <div className="bg-white dark:bg-secondary-dark-bg dark:text-gray-200 h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3  bg-no-repeat bg-cover bg-center">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className='text-2xl'>$63,400.78</p>  
            </div> 
        ...
        <div className='flex m-3 flex-wrap justify-center gap-1 items-center'>
          {earningData.map((item) => (
            ...
            >
              <button type="button" style={{color: item.iconColor,backgroundColor:item.iconBg}} className='text-2xl opacity-0.9 rouunded-full p-4 hover:drop-shadow-xl'>
                {item.icon}
              </button>
              <p className='mt-3'>
            ...
            <div className='mt-10 flex gap-10 flex-wrap justify-center'>
              <div className='border-r-1 border-color m-4 pr-10'>
                <div>
                  ...
                  <p className="text-gray-500 mt-1  dark:text-gray-200 dark:bg-secondary-dark-bg">Budget</p>
                </div>
                <div className='mt-8'>
                  <p>
                  ...
                  <p className="text-gray-500 mt-1  dark:text-gray-200 dark:bg-secondary-dark-bg">Expense</p>
                </div>
